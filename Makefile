...
SV_SRC = core_l1d_l1i.sv core.sv exec.sv decode_mips.sv shiftregbit.sv shift_right.sv mul.sv fpu.sv fpu_add.sv fpu_mul.sv fp_compare.sv fp_special_cases.sv find_first_set.sv divider.sv l1d.sv l1i.sv machine.vh rob.vh uop.vh fp_compare.vh ram1r1w.sv ram2r1w.sv popcount.sv count_leading_zeros.sv unsigned_divider.sv fair_sched.sv ppa32.sv csa.sv rf4r2w.sv reg_ram1rw.sv l2.sv mipsseg.sv tlb.sv predecode.sv
