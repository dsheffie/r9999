#!/bin/bash
# run_l2_credit_formal.sh -- UNBOUNDED proof of the L2 transaction-pool control core
...
COMMON="
  read_verilog -sv -formal -DFORMAL -DENABLE_L2_INCLUSION -I.. formal_l2_txn.sv ../l2_txn_ctrl.sv
  hierarchy -check -top formal_l2_txn
"
...
if grep -qE 'define-fun \|formal_l2_txn_a\| .*Bool true' $WORK/l2.smt2; then
